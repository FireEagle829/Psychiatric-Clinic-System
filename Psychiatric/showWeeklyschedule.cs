...
{
    public partial class showWeeklyschedule : Form
    {

        private static showWeeklyschedule frm;
        public static showWeeklyschedule GetForm
        {
            get {
                return frm;
            }
        ...
        public void init()
        {
            ...
            DataTable table = db.Read("SELECT Day, Hour FROM psychiatric.dbo.reservations");
        ...
        public showWeeklyschedule()
        {
            InitializeComponent();
            init();
        }
        private void showWeeklyschedule_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                listReservedCustomers list = new listReservedCustomers(rowIndex, columnIndex);
                list.ShowDialog();
                list.BringToFront();
            }
        }
